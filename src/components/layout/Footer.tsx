...
const Footer = () => {
  return (
    <footer className="bg-[#14181f] text-white">
      <div className="container-main py-12 md:py-16">
        <div className="mb-10 grid gap-4 rounded-lg border border-white/10 bg-white/[0.04] p-6 shadow-[0_24px_70px_-42px_rgba(0,0,0,0.72)] md:grid-cols-[1.2fr_auto] md:items-center">
          <div>
        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-5 md:gap-12">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              <li>
                <Link to="/" className="text-white/68 transition-colors hover:text-white">
                  Главная
                </Link>
              </li>
              <li>
                <Link to="/uslugi" className="text-white/68 transition-colors hover:text-white">
                  Услуги
                </Link>
              </li>
              <li>
                <Link to="/stoimost" className="text-white/68 transition-colors hover:text-white">
                  Стоимость
                </Link>
              </li>
              <li>
                <Link to="/contact" className="text-white/68 transition-colors hover:text-white">
                  Контакты
                </Link>
              </li>
              <li>
                <Link to="/auth" className="text-white/68 transition-colors hover:text-white">
                  Личный кабинет
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              <li>
                <Link to="/zamena-provodki" className="text-white/68 transition-colors hover:text-white">
                  Замена проводки
                </Link>
              </li>
              <li>
                <Link to="/sborka-elektroshchita" className="text-white/68 transition-colors hover:text-white">
                  Сборка щита
                </Link>
              </li>
              <li>
                <Link to="/elektromontazh-v-kvartire" className="text-white/68 transition-colors hover:text-white">
                  Электрика в квартире
                </Link>
              </li>
              <li>
                <Link to="/elektromontazh-v-dome" className="text-white/68 transition-colors hover:text-white">
                  Электрика в доме
                </Link>
              </li>
              <li>
        ...
        <div className="mt-10 border-t border-white/10 pt-8">
          <div className="grid gap-3 text-sm sm:grid-cols-3">
            <Link to="/elektrik-v-tiraspole" className="text-white/60 transition-colors hover:text-white">
              Электрик в Тирасполе
            </Link>
            <Link to="/elektrik-v-benderah" className="text-white/60 transition-colors hover:text-white">
              Электрик в Бендерах
            </Link>
            <Link to="/elektrik-v-slobodzee" className="text-white/60 transition-colors hover:text-white">
