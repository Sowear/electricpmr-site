...
CREATE INDEX IF NOT EXISTS idx_estimate_history_estimate_id ON estimate_history (estimate_id, changed_at);
CREATE INDEX IF NOT EXISTS idx_estimate_send_log_estimate_id ON estimate_send_log (estimate_id);
CREATE INDEX IF NOT EXISTS idx_payments_project_id ON payments (project_id);
CREATE INDEX IF NOT EXISTS idx_payments_account_id ON payments (account_id);
CREATE INDEX IF NOT EXISTS idx_payments_verified ON payments (verified);
CREATE INDEX IF NOT EXISTS idx_finance_entries_created_at ON finance_entries (created_at);
CREATE INDEX IF NOT EXISTS idx_finance_entries_payment_id ON finance_entries (payment_id);
CREATE INDEX IF NOT EXISTS idx_finance_entries_payout_id ON finance_entries (payout_id);
CREATE INDEX IF NOT EXISTS idx_notes_entity ON notes (entity_type, entity_id);
CREATE INDEX IF NOT EXISTS idx_profit_snapshots_project ON profit_snapshots (project_id, object_id);
CREATE INDEX IF NOT EXISTS idx_employee_payouts_user_id ON employee_payouts (user_id);
CREATE INDEX IF NOT EXISTS idx_estimate_participants_estimate_id ON estimate_participants (estimate_id);
CREATE INDEX IF NOT EXISTS idx_catalog_items_created_by ON catalog_items (created_by);
CREATE INDEX IF NOT EXISTS idx_work_examples_published_category ON work_examples (is_published, category);
