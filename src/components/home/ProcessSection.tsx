      ...
      <div className="container-main max-w-4xl">
        ...
        >
          <h2 className="font-display text-2xl md:text-3xl font-bold mb-4">
            Процесс работы: понятная последовательность без лишнего хаоса
          </h2>
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Как мы работаем без лишних сложностей: чёткий процесс от первой заявки до гарантийного обслуживания. Каждый этап строго контролируется, всё делается аккуратно и по нормам.
          </p>
        </motion.div>
